...
if(isset($_POST['update'])) {
    ...
    if($user) {
        ...
        if(empty($_FILES['user_image'])) {
            ...
            $session->message("The user has been updated"); // needs to be set BEFORE redirect
            redirect("users.php");

        } else {

            // ha van fájl kiválasztva

            $user->set_file($_FILES['user_image']);

            $user->upload_photo(); // avatar upload only (no create)

            $user->save(); // save data to db (update lesz)
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- we need to output the pswd so it wont get empty after update -->
